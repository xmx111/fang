...
public class AgentThirdAccountAction extends BaseTemplateAction<AgentThirdAccount, Long> {
    ...
    public String index() throws ServiceException {
        return this.toView("agentthirdaccount/agent-Third-Account-index");
    }
    ...
    public String operator(Long id, ModelMap map) throws ServiceException {
        ...
        return this.toView("agentthirdaccount/agent-Third-Account-operator");
    }
    ...
    @ResponseBody
    public Object save(AgentThirdAccount dto) throws ServiceException {
        if (dto.getId() == null)
            return add(dto);
        else
            return modify(dto);
