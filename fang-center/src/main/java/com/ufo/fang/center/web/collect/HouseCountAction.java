...
public class HouseCountAction extends BaseTemplateAction<HouseCount, Long> {
    ...
    public String index() throws ServiceException {
        return this.toView("housecount/house-Count-index");
    }
    ...
    public String operator(Long id, ModelMap map) throws ServiceException {
        ...
        return this.toView("housecount/house-Count-operator");
    }
    ...
    @ResponseBody
    public Object save(HouseCount dto) throws ServiceException {
        if (dto.getId() == null)
            return add(dto);
        else
            return modify(dto);
