...
<#assign js_url='[/statics/js/agent/agentIndex.js]'>
                ...
                <div  class="easyui-layout" fit="true" border="false">
                    <div region="center"  border="false">
                        <table id="Data_Grid" fit="true" toolbar="#Data_Grid_TB">
                            <thead>
                            <tr>
                                <th field="name" sortable="true" width="60">姓名</th>
                                <th field="moblie" sortable="true" width="60">手机</th>
                                <th field="password" sortable="true" width="60">密码</th>
                                <th field="createTime" sortable="true" width="150">创建时间</th>
                                <th field="modifyTime" sortable="true" width="60">修改时间</th>
                            </tr>
                            </thead>
                        </table>
