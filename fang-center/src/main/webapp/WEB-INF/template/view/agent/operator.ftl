...
<script language="text/javascript" src="/statics/js/agent/operator.js"></script>
<div title="Agent信息" class="tab-container">
    <form id="Data_Form" method="post" >
        ...
        <table class="dialog-table">
            ...
            <tr>
                <td class="lable"></td>
                <td>
                        <input type="text" id="moblie" name="moblie" class="easyui-validatebox wid200"></input>
                </td>
            </tr>
            <tr>
                <td class="lable"></td>
            ...
            <tr>
                <td class="lable"></td>
                <td>
                        <input type="text" id="modifyTime" name="modifyTime" class="easyui-validatebox wid200"></input>
                </td>
            </tr>
        </table>
