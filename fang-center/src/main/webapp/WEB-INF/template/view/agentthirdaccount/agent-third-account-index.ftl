<div class="row">
    <div class="col-md-12 grid-main">
        <div class="row search-form-default">
            <div class="col-md-12">
                <div class="row">
                    <form id="agent-third-account-form" action="#">
                        <div class="col-md-9">
        ...
        <div class="row grid-default">
            <div class="col-md-12">
                <table id="agent-third-account-grid"></table>
            </div>
        </div>
    </div>
</div>
<script src="/statics/js/agentthirdaccount/agent-third-account-index.js" type="text/javascript"></script>