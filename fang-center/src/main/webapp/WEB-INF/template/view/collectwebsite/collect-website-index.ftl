<div class="row">
    <div class="col-md-12 grid-main">
        <div class="row search-form-default">
            <div class="col-md-12">
                <div class="row">
                    <form id="collect-website-form" action="#">
                        <div class="col-md-9">
        ...
        <div class="row grid-default">
            <div class="col-md-12">
                <table id="collect-website-grid"></table>
            </div>
        </div>
    </div>
</div>
<script src="/statics/js/collectwebsite/collect-website-index.js" type="text/javascript"></script>