<#assign basicURL="/collectwebsite/">
<#assign js_config=[
"'basicURL':'${basicURL}'",
"'urlMap':{
...
<#assign js_url='[/statics/js/collectwebsite/collectWebsiteIndex.js]'>
                ...
                <div  class="easyui-layout" fit="true" border="false">
                    <div region="center"  border="false">
                        <table id="Data_Grid" fit="true" toolbar="#Data_Grid_TB">
                            <thead>
                            <tr>
                                <th field="url" sortable="true" width="60">网站地址</th>
                                <th field="icon" sortable="true" width="60">网站图标</th>
