                ...
                <div  class="easyui-layout" fit="true" border="false">
                    <div region="center"  border="false">
                        <table id="Data_Grid" fit="true" toolbar="#Data_Grid_TB">
                            <thead>
                            <tr>
                                <th field="trafficDescribe" sortable="true" width="60">交通状况</th>
                                <th field="university" sortable="true" width="60">大学</th>
                                <th field="school" sortable="true" width="60">中小学</th>
                                <th field="kindergarten" sortable="true" width="60">幼儿园</th>
                                <th field="mall" sortable="true" width="60">商场</th>
                                <th field="postOffice" sortable="true" width="60">邮局</th>
                                <th field="bank" sortable="true" width="60">银行</th>
                                <th field="hospital" sortable="true" width="60">医院</th>
                                <th field="other" sortable="true" width="60">其它</th>
                                <th field="tel" sortable="true" width="60">联系电话</th>
