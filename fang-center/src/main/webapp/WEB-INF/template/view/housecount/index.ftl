...
<#assign js_url='[/statics/js/housecount/houseCountIndex.js]'>
                ...
                <div  class="easyui-layout" fit="true" border="false">
                    <div region="center"  border="false">
                        <table id="Data_Grid" fit="true" toolbar="#Data_Grid_TB">
                            <thead>
                            <tr>
                                <th field="clickNum" sortable="true" width="80">点击数</th>
                                <th field="collectNum" sortable="true" width="80">采集数</th>
                                <th field="informNum" sortable="true" width="80">举报数</th>
                            </tr>
                            </thead>
                        </table>
