<form id="house-release-operator" action="/houserelease/save.json" method="post">
    ...
    <div class="form-input">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon">标签1</span>
                    <input type="text" name="tag1" class="form-control" placeholder="标签1">
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon">标签2</span>
                    <input type="text" name="tag2" class="form-control" placeholder="标签2">
                </div>
            </div>
        </div><br>
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon">标签3</span>
                    <input type="text" name="tag3" class="form-control" placeholder="标签3">
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
...
<script language="text/javascript" src="/statics/js/houserelease/house-release-operator.js"></script>