...
<script language="text/javascript" src="/statics/js/houserelease/operator.js"></script>
<div title="HouseRelease信息" class="tab-container">
    <form id="Data_Form" method="post" >
        ...
        <table class="dialog-table">
            ...
            <tr>
                <td class="lable">标签1</td>
                <td>
                        <input type="text" id="tag1" name="tag1" class="easyui-validatebox wid200"></input>
                </td>
            </tr>
            <tr>
                <td class="lable">标签2</td>
                <td>
                        <input type="text" id="tag2" name="tag2" class="easyui-validatebox wid200"></input>
                </td>
            </tr>
            <tr>
                <td class="lable">标签3</td>
                <td>
                        <input type="text" id="tag3" name="tag3" class="easyui-validatebox wid200"></input>
                </td>
            </tr>
            <tr>
