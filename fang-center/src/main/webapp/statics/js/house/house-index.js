$(document).ready(function () {
    ...
    grid.initJqGrid({
        ...
        colNames : ['id', '内部编码', '采集房源_uuid', '用途', '销售类型', '状态', '楼盘名称', '省', '市', '区县', '商圈', '地址', '楼号', '单元', '房号', '楼层', '总楼层', '室', '厅', '厨', '卫', '阳台', '位置', '层数', '级别', '排量', '特色', '价格', '最低首付', '产权性质', '建筑年代', '建筑面积', '住宅类型', '装修类型', '朝向', '建筑结构', '产证满五', '唯一住房', '看房时间', '内部编号', '税费类型', '支付方式', '押', '付', '委托方式', '委托时间', '交房时间', '委托编号', '来源', '现状', '产权', '装修', '证书', '配套', '家具', '家电', '付款方式', '付拥', '钥匙', '钥匙编号', '业主', '业主电话', '联系人', '房产证', '国籍', '联系说明', '备注', '创建时间', '修改时间'],
        colModel : [
