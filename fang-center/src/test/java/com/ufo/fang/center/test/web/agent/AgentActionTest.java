package com.ufo.fang.center.test.web.agent;
...
* @author <Authors name>
    ...
    * @version 1.0
    */
    public class AgentActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/agent/index.htm").with(apiSignRequestPostProcessor))
