package com.ufo.fang.center.test.web.agentthirdaccount;
...
/**
* AgentThirdAccountAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class AgentThirdAccountActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/agentThirdAccount/index.htm").with(apiSignRequestPostProcessor))
