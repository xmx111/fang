package com.ufo.fang.center.test.web.chinaArea;
...
/**
* ChinaAreaAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-18</pre>
    * @version 1.0
    */
    public class ChinaAreaActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/chinaArea/index.htm").with(apiSignRequestPostProcessor))
