package com.ufo.fang.center.test.web.collectwebsite;
...
/**
* CollectWebsiteAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class CollectWebsiteActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/collectWebsite/index.htm").with(apiSignRequestPostProcessor))
