package com.ufo.fang.center.test.web.grading;
...
/**
* GradingAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class GradingActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/grading/index.htm").with(apiSignRequestPostProcessor))
