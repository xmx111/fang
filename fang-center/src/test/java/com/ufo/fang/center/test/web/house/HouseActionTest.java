package com.ufo.fang.center.test.web.house;
...
* @author <Authors name>
    ...
    * @version 1.0
    */
    public class HouseActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/house/index.htm").with(apiSignRequestPostProcessor))
