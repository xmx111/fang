package com.ufo.fang.center.test.web.housecount;
...
/**
* HouseCountAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class HouseCountActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/houseCount/index.htm").with(apiSignRequestPostProcessor))
