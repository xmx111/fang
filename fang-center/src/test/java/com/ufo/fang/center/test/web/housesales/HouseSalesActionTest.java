package com.ufo.fang.center.test.web.houseSales;
...
/**
* HouseSalesAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class HouseSalesActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/houseSales/index.htm").with(apiSignRequestPostProcessor))
