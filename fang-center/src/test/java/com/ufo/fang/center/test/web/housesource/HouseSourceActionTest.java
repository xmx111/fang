package com.ufo.fang.center.test.web.housesource;
...
/**
* HouseSourceAction Tester.
*
* @author <Authors name>
    * @since <pre>2016-07-19</pre>
    * @version 1.0
    */
    public class HouseSourceActionTest extends AbstractWebTest {
    ...
    */
    ...
    public void testIndex() throws Exception {
        ...
        String html = mvc.perform(get("/houseSource/index.htm").with(apiSignRequestPostProcessor))
